...
install.packages("https://cran.rstudio.com/bin/windows/contrib/3.4/KoNLP_0.80.1.zip",
                 repos = NULL)
install.packages("https://cran.r-project.org/src/contrib/Archive/KoNLP/KoNLP_0.80.2.tar.gz", repos = 
                  NULL, type="source", INSTALL_opts = c('--no-lock'))
...
install.packages(c("hash", "tau", "Sejong", 
                   ...
                   "promises", "later", "sessioninfo", "xopen", 
                   "bit64", "blob", "DBI", "memoise", 
                   "plogr", "covr", "DT", "rcmdcheck", "rversions"), type = "binary")
install.packages(c('htmlwidgets', 'htmltools', 'yaml', 'base64enc', 
                    'KoNLP', 'jsonlite', 'dplyr', 'reshape2'))
install.packages('devtools')
library(devtools)
...
#install.packages('manipulate')#inspect 를 위한
data("Adult")
Adult
str(Adult)
dim(Adult)
...
wordcloud(df$word, df$freq, min.freq = 2,
          ...
          rot.per = .1, colors = pal, family = "malgun") #pas --> pal!!!!
