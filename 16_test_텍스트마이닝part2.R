...
#단어에 감정 점수 부여하기(dplyr::left_join() : word 기준 감정 사전 결합)
...
#감정 사전 수정하기
#"소름이" , "소름" , "미친"의 polarity를 양수 2로 수정
new_dic <- dic %>%
...
#Q7. 'Q3'에서 만든 데이터를 이용해 '긍정 댓글에 가장 자주 사용된 단어'를 언급한 댓글을 감정 점수가#### 
#높은 순으로 출력하세요.
score_comment %>%
...
#Q8. 'Q3'에서 만든 데이터를 이용해 '부정 댓글에 가장 자주 사용된 단어'를 언급한 댓글을#### 
#감정 점수가 낮은 순으로 출력하세요.
score_comment %>%
